	...
	<div class="entry-content">
		...
		the_content( sprintf(
			wp_kses(
				...
				__( 'Continue reading<span class="screen-reader-text"> "%s"</span>', 'st-annes-church-of-rajakai' ),
				array(
					'span' => array(
						'class' => array(),
					),
		...
		wp_link_pages( array(
			'before' => '<div class="page-links">' . esc_html__( 'Pages:', 'st-annes-church-of-rajakai' ),
			'after'  => '</div>',
		) );
		?>
	</div><!-- .entry-content -->
